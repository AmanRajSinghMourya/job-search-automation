...
The repo is Punish-only. The workflow runs `job_search_for_punish.py`, searches full-time Data Analyst / BI roles only, excludes internships, runs daily at 10:00 PM IST, and the Apps Script emails only `punishmidha21@gmail.com`.
